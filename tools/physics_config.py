...
from physics_design import (AFFECTED, COLLIDERS, CREATURE_COLLIDERS, MOUTH, MOUTH_CHAINS, PARENT,  # noqa: E402
                            PROPS, STRETCH)
...
def main():
    ...
    print(f'Anatomy/ocbp.ini: {len(ATTACH)} bones attached, [Props], [Mouth], [Bones] ({len(bone_table(bind[PARENT]))} nodes, '
